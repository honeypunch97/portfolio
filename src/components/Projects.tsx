    ...
    <ProjectsContainer id="Projects">
      <InnerContainer>
        ...
        <div className="project-item">
          <h3 className="project-title">My Instagram</h3>
          <p className="project-subtitle">2023.11 (1人 개인 프로젝트)</p>
          <div className="content-box">
            <div className="media-box">
              <iframe
                width="600"
                height="338"
                src="https://www.youtube.com/embed/HAB89r1cgS4?si=_wRzEUSPJmMX1ksW"
            ...
            <div className="description-box">
              <p>
                <b>인스타그램의 '피드' 관련 기능을 구현한 웹사이트</b>입니다. 현재 작업중인 프로젝트입니다.
              </p>
              <p>
                <em>Typescript</em>에 익숙해지고, <em>Firebase</em> Auth, DB, Storage기능들을 이용해 프로젝트를 진행하고
                있습니다. Redux에는 익숙해졌지만, 다른 상태관리 라이브러리도 사용해보는게 좋을 것 같아, 상태관리
                라이브러리로 <em>Recoil</em>을 사용했습니다. 현재 진행상태는 회원가입, 로그인, 작성, 삭제, 검색 기능을
                구현완료했으며, 반응형작업도 병행하며 진행중입니다.
              </p>
              <button onClick={() => openLinkInNewTab("https://github.com/honeypunch97/myInstagram/tree/main")}>
              ...
              <ul>
                <li>
                  ...
                  <p>
                    회원가입 및 로그인(with.Firebase Authentication), 피드생성(다중 이미지 with.Firebase Cloud Storage),
                    삭제, 수정, 댓글, 좋아요, 검색(유저이름, 태그) 등
                  </p>
                </li>
                <li>
                  <span>
                  ...
                  <p>
                    <a href="https://github.com/honeypunch97/myInstagram" target="_blank">
                      https://github.com/honeypunch97/myInstagram
                    </a>
                  </p>
                </li>
                <li>
                  ...
                  <p>URL이 없습니다. (추후 Firebase 호스팅 예정)</p>
                </li>
                <li>
                  <span>
                    <i className="xi-check"></i>Frontend
                  </span>
                  <p>React, TypeScript, Recoil, Styled-components</p>
                </li>
                <li>
                  <span>
                    <i className="xi-check"></i>Backend
                  </span>
                  <p>Firebase</p>
                </li>
              </ul>
        ...
        <div className="project-item">
          ...
          <div className="content-box">
            ...
            <div className="description-box">
              ...
              <p>
                <em>Typescript</em>를 학습을 위해 여러 토이 프로젝트를 만들어 본 후 최대한 빠르게 제작해봤습니다. 그
                과정에서 번거로움도 느꼈지만, 왜 다른 개발자들이 Typescript를 선호하고 권유하는지 느낄 수 있었습니다.
                또한 <em>styled-components</em>를 사용해 디자인부분도 동시에 작업했습니다.
              </p>
        ...
        <div className="project-item">
          ...
          <div className="content-box">
            ...
            <div className="description-box">
              <p>
                공공데이터 포털(DATA.GO.KR) 오픈 API(농림축산식품부 농림축산검역본부_동물보호관리시스템 유기동물 정보
                조회 서비스)를 이용한 <b>유기견 조회 및 입양신청 사이트</b>입니다. 팀원이 평소에 애견인이고, 저 또한
                사회시스템에 관심이 있기 때문에 유기견 관련 주제를 선정했습니다.
              </p>
              <p>
              ...
              <p>
                ...
                <em>Node.JS(with Express)</em>를 사용해 MVC패턴으로 웹서버 작업을 했습니다. 데이터베이스와 AWS연동을
                하지 못해 아쉬움이 남지만, 한정된 기간내에 많은 양을 작업한 열정적인 프로젝트였습니다.
              </p>
              ...
              <ul>
                <li>
                  ...
                  <p>회원가입 및 로그인, 유기견 조회 및 입양신청, 반려견 관련 정보전달 및 퀴즈, 관련 상품 쇼핑몰 등</p>
                </li>
                <li>
                  <span>
                    <i className="xi-check"></i>GitHub
        ...
        <div className="project-item">
          ...
          <div className="content-box">
            ...
            <div className="description-box">
              <p>
                <b>기존 탐라는 전기차(https://www.tamraev.com/) 페이지를 재구성한 웹사이트</b> 입니다. <em>React</em>와
                <em>Styled-components</em>를 사용하여 기존 프로젝트에서 새로운 컨텐츠들을 추가해 재구성 했습니다.
              </p>
              <p>
                처음으로 <em>React</em>를 사용한 프로젝트를 진행해서 수정되거나 기획이 엎어지는 케이스가 많았지만{" "}
                <em>Figma</em>를 통해 팀원과의 의견조율을 진행했고 이미지가 많기 때문에 더보기 버튼이나 lazy loading을
                이용해 랜더링 시간을 줄였습니다. 또한 로딩페이지를 만들어 로딩중에는 표시하도록 하여 사용자에게 현재
                상태를 안내하도록 구현했습니다.
              </p>
              <p>
                짧은 기간동안 빠르게 결정할 일이 많아 팀원과의 의견차이도 많았습니다. 서로 간단한 예시나 시안같은것으로
                더 좋은 선택안을 고를 수 있도록 노력했습니다. 특히 <em>Figma</em>를 통한 디자인적인 의사소통이
                좋았습니다.
              </p>
        ...
        <div className="project-item">
          ...
          <div className="content-box">
            ...
            <div className="description-box">
              <p>
                <b>기존 이화여대(https://www.ewha.ac.kr/ewha/) 페이지를 재구성한 웹사이트</b> 입니다. 순수 바닐라
                <em>Javascript</em>를 사용하여 기존 프로젝트에서 새로운 컨텐츠들을 추가해 재구성 했으며 pc버전과
                mobile버전을 따로 작업했습니다.
              </p>
              <p>
                처음으로 진행한 프로젝트로 바닐라JS를 사용하여 사이트의 외적인 퍼블리싱을 재구성했습니다. 기존 컨텐츠에
                새로운 컨텐츠들을 추가하여 페이지를 리뉴얼하였습니다. Mobile버전은 vw로 작업하여 기기 화면에 상관없이
                비율을 유지할 수 있도록 개발했습니다.
              </p>
              <p>
                웹의 모든 애니메이션을 라이브러리없이 직접만들어 보는 좋은 경험이었습니다. 같은 내용을 모바일작업에서는
                유사한 라이브러리로 대체해보며 자주 사용하는 라이브러리에 대한 경험도 향상시켰습니다. 저는 메인페이지와
                대학, 대학원페이지를 제작했으며 팀장역할을 맡아 팀원들의 어려움을 같이 해결했습니다.
              </p>
